...
class AdsbannerController extends Controller
{
    ...
    public function index()
    {
        ...
        $breadcrumb = [
            ['name' => 'ตั้งค่าโฆษณา (แบรนเนอร์)'],
        ];

        return view('admin.ads.banner.main', [
    ...
    public function add(){
        ...
        $displays = TbSettingDisplay::where('id',1)->where('display_show',1)->get();

        return view('admin.ads.banner.form', [
            'breadcrumb' => $breadcrumb,
            'data' => '',
            'displays' => $displays,
        ]);
    ...
    public function crate(Request $request){
        ...
        return redirect()->route('ads.banner.edit',[$data->id])->with('feedback', 'เพิ่มข้อมูลเรียบร้อยแล้ว!');
    ...
    public function jsondata()
    {
        ...
        $data = TbAd::where('ads_position',2)->get();
        ...
        return Datatables::of($data)
                ...
                ->addColumn('actions', function ($data) {
                    ...
                    $name = $data->ads_img;
                    return view('admin.ads.banner.button', compact('id','status','name'));
                })
                ->escapeColumns([])
                ->addIndexColumn()
                ->make(true);
    ...
    public function getDisplay(){
        ...
        $result = TbSettingDisplay::where('id',1)->where('display_show',1)->first(1);
        return $result;
