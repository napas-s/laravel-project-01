...
class AdsheadController extends Controller
{
    ...
    public function index()
    {
        ...
        $breadcrumb = [
            ['name' => 'ตั้งค่าโฆษณา (ส่วนหัว)'],
        ];

        return view('admin.ads.head.main', [
    ...
    public function add(){
        ...
        return view('admin.ads.head.form', [
            'breadcrumb' => $breadcrumb,
            'data' => '',
            'displays' => $displays,
        ]);
    ...
    public function crate(Request $request){
        ...
        return redirect()->route('ads.head.edit',[$data->id])->with('feedback', 'เพิ่มข้อมูลเรียบร้อยแล้ว!');
    ...
    public function jsondata()
    {
        ...
        $data = TbAd::where('ads_position',1)->get();
        ...
        return Datatables::of($data)
                ...
                ->addColumn('actions', function ($data) {
                    ...
                    $name = $data->ads_img;
                    return view('admin.ads.head.button', compact('id','status','name'));
                })
                ->escapeColumns([])
                ->addIndexColumn()
                ->make(true);
