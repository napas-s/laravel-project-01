    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
            <h4 class="card-title transform-capitalize">หมวดหมู่บทความ</h4>
        </div>
        <div class="card-body">
          <div class="toolbar"></div>
          <table id="datatable" data-create="{{ route('category.add') }}" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
              <tr>
                <th style="width: 15px" class="disabled-sorting text-right"></th>
                <th>หมวดหมู่</th>
                <th>Permalink Link</th>
                <th style="width: 80px">แถบเมนู</th>
            ...
            columns: [
                ...
                {data: 'status',
                    render: function(data){
                        let status
                        if(data == 2){
                            status = '<span class="badge badge-success">แสดงบนแถบเมนู</span>'
                        }else if(data == 1){
                            status = '<span class="badge badge-danger">ไม่แสดงบนแถบเมนู</span>'
                        }
                        return status
                    }
                },
