    ...
    <div class="col-md-12">
        ...
        @else
            {{
                Form::model($data, [
                    'novalidate',
                    'route' => ['ads.banner.update',[$data->id]],
                    'id'=>'data-form',
                    'method' => 'put',
                    'files' => true
                ])
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group has-label text-align-center">
                                ...
                                @else
                                    <img id="blah1" src="{{ asset('assets/fontend/images/AdsB/ads_661_314.webp') }}" alt="..." class="full-width" rel="nofollow">
                                @endisset
                            </div>
                            <div class="has-label">
                                <label>รูปภาพ *</label>
...
@if(!empty($data->ads_display))
    <script>
        ...
        $.ajax({
            type: "GET",
            url: '{!! route('ads.banner.getDisplay') !!}',
            cache: false,
            beforeSend: function () { },
